...
public class RandomNumberGeneratorWorker3 extends Worker {
    private static final String APPLICATION_TAG= RandomNumberGeneratorWorker3.class.getSimpleName();
        ...
        while (i<5 && !isStopped()){
            try{
                ...
                if(mIsRandomGeneratorOn){
                    ...
                    Log.d(TAG,"Worker 3: "+Thread.currentThread().getId()+", Random Number: "+ mRandomNumber);
                    i++;
                }
