...
public class RandomNumberGeneratorWorker2 extends Worker {
    private static final String APPLICATION_TAG= RandomNumberGeneratorWorker2.class.getSimpleName();
        ...
        while (i<5 && !isStopped()){
            try{
                ...
                if(mIsRandomGeneratorOn){
                    ...
                    Log.d(TAG,"Worker 2: "+Thread.currentThread().getId()+", Random Number: "+ mRandomNumber);
                    i++;
                }
